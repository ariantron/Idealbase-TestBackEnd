...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\TouchService $instance */
         ...
         * @static 
         */ 
        public static function store($touchStoreRequest)
        {
                        /** @var \App\Services\TouchService $instance */
                        return $instance->store($touchStoreRequest);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function show($touch)
        {
                        /** @var \App\Services\TouchService $instance */
                        return $instance->show($touch);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function update($touchUpdateRequest, $touch)
        {
                        /** @var \App\Services\TouchService $instance */
                        return $instance->update($touchUpdateRequest, $touch);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function destroy($touch)
        {
                        /** @var \App\Services\TouchService $instance */
                        return $instance->destroy($touch);
        }
...
namespace  { 
            ...
            class TouchService extends \App\Facades\TouchFacade {}
